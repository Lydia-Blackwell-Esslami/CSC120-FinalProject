...
public class Player extends Person {
    ...
    public void sleep(){
        if (this.location.contentEquals("bed") || this.location.contentEquals("office")){
            this.updateTime(8);
    ...
    public void getUp(){
        if (this.location.contentEquals("bed")){
    ...
    public void look(){
        if (this.location.contentEquals("home, bed")){
        ...
        } else if (this.location.contentEquals("home, bedroom")){
        ...
        } else if (this.location.contentEquals("home, hallway")){
        ...
        } else if (this.location.contentEquals("home, bathroom")){
            System.out.println("You are in the bathroom. There is a shower, toilet, sink, and toothbrush.");
        } else if (this.location.contentEquals("home, kitchen")){
            System.out.println("You are in the kitchen. There is a large refridgerator in front of you. You can go to the hallway, to the living room, or outside. Your shoes and keys are by the door.");
        } else if (this.location.contentEquals("home, living room")) {
            System.out.println("You are in the living room. There is a couch and televsion. Your shoes and keys are by the door. You can go out, or to the kitchen, or to the hallway.");
        } else if (this.location.contentEquals("lost")){
            System.out.println("You are lost. You have no idea where you are.");
        } else if (this.location.contentEquals("outside, driveway")){
            System.out.println("You are in your driveway. You can go back inside, get in your car, or try to walk somewhere");
        } else if (this.location.contentEquals("outside, bus stop")){
            System.out.println("You are at the bus stop. Wait for a bus?");
        } else if (this.location.contentEquals("outside, bus")){
            System.out.println("You are riding a bus");
            System.out.println("...");
            System.out.println("The bus just stopped!");
        } else if (this.location.contentEquals("outside, auto parts store")){
            System.out.println("You are in the auto parts store. The cashier is looking at you with a bored expression");
        } else if (this.location.contentEquals("car")){
            System.out.println("You are in your car! Drive somewhere?");
        } else if (this.location.contentEquals("outside, diner")){
        ...
        } else if (this.location.contentEquals("outside, trailer park")){
        ...
        } else if (this.location.contentEquals("outside, suburbs")){
        ...
        } else if (this.location.contentEquals("work, office")){
            System.out.println("You are in your office. Your computer is on your desk.");
        } else if (this.location.contentEquals("work, parking lot")){
            System.out.println("You are in the parking lot, surrounded by unsold cars");
        } else if (this.location.contentEquals("work, repair shop")){
        ...
        } else if (this.location.contentEquals("computer")){
            computer.showOptions();
        } else if (this.location.contentEquals("phone")){
            phone.showOptions();
        } else if (this.location.contentEquals("outside, grocery store")){
    ...
    public void go(String destination){
        if((this.location.contains("home")&&destination.contains("home"))||
        (this.location.contains("outside")&& destination.contains("outside")||
        (this.location.contains("work")&& destination.contains("work")))){
    ...
    public void drive(String destination){
        if (this.location.contentEquals("car")){
            this.location = destination;
            this.look();
        } else {
    ...
    public void shower(){
        if (this.location.contentEquals("bathroom")){
